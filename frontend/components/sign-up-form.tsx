...
export function SignUpForm() {
  ...
  const handleGoogleLogin = () => {
    toast.info("Google OAuth coming soon!", {
      description: "For now, please use email/password sign up. Google authentication will be available in the next update."
    })
  }

  const handleGitHubLogin = () => {
    toast.info("GitHub OAuth coming soon!", {
      description: "For now, please use email/password sign up. GitHub authentication will be available in the next update."
    })
  }
  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Start verifying digital files with AEGIS</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          {errors.confirmPassword && <p className="text-destructive text-sm mt-1.5">{errors.confirmPassword}</p>}
        </div>
